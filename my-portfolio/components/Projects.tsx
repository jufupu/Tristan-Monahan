...
const Projects = () => {
    const projects = [
        ...
        },
        {
            ...
            description: 'A solo interior designer needed a client facing website she could drive traffic too. Designed on figma, Built with replit, Both desktop and mobile optimised.',
            link: 'https://hackneycollective.co.uk/',
            thumbnail: '/img/hackney-collective-showcase.png',
        },
        {
            title: 'Lavender Contracts',
            description: 'A local cleaning company in scotland. Website built to drive traffic too. Designed on Figma. Built with replit. Both desktop and mobile optimised.',
