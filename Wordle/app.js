...
//Use this to pick the word
//const wordle = 'SONIC'
//comment out this and use const above for own word
let wordle

//Use this for the random word API
//To use run 'npm run start:backend'
const getWordle = () => {
...
const checkRow = () => {
    ...
    if (currentTile > 4) {
        //comment out this section to use own word
